...
func main() {
	...
	fmt.Println(`Для прерываения программы по желанию пользователя при нажатии клавиш Ctrl + C, создаём специальный канал,
...
как происходит в случае с моментальным завершением через context.Context`)
